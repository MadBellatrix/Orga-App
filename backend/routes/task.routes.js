...
import { listTaskQuerySchema, createTaskSchema, updateTaskSchema } from "../validators/task.schema.js";
...
router.post("/", requireAuth, requirePermission("task:create"), validateBody(createTaskSchema), createTask);
router.patch("/:id", requireAuth, requirePermissionOrOwner("task:update", loadTaskOwner), validateBody(updateTaskSchema), updateTask);
